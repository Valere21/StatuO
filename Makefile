#############################################################################
# Makefile for building: Hastus
# Generated by qmake (3.1) (Qt 6.5.3)
# Project:  Hastus.pro
# Template: app
# Command: C:\Qt\6.5.3\mingw_64\bin\qmake.exe -o Makefile Hastus.pro -spec win32-g++ "CONFIG+=debug" "CONFIG+=qml_debug"
#############################################################################
...
Makefile: Hastus.pro ../../Qt/6.5.3/mingw_64/mkspecs/win32-g++/qmake.conf ../../Qt/6.5.3/mingw_64/mkspecs/features/spec_pre.prf \
		...
		qml.qrc
	$(QMAKE) -o Makefile Hastus.pro -spec win32-g++ "CONFIG+=debug" "CONFIG+=qml_debug"
