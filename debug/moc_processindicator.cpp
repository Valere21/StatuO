...
static constexpr auto qt_meta_stringdata_CLASSProcessIndicatorENDCLASS = QtMocHelpers::stringData(
    "ProcessIndicator"
);
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_CLASSProcessIndicatorENDCLASS_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_CLASSProcessIndicatorENDCLASS_t qt_meta_stringdata_CLASSProcessIndicatorENDCLASS = {
    {
        QT_MOC_LITERAL(0, 16)   // "ProcessIndicator"
    },
    "ProcessIndicator"
};
